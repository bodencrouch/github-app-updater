...
from github_app_updater._compat import ensure_directory_exists
from github_app_updater._compat import is_frozen, requires_admin
...
class Restarter:
    ...
    def _win_overwrite(self):
        ...
        script_dir = Path(tempfile.gettempdir()) / "app_updater_update"
    ...
    def _create_windows_update_script(
        ...
        script = textwrap.dedent(f"""\
            ...
            # Auto-generated by the host app Toolset updater
